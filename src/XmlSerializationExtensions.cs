...
/* Liste aller Codepage-IDs bzw. -Namen
 * http://stackoverflow.com/questions/2574289/codepage-id-to-codepage-name-getencoding-equivalent-in-delphi
...
{
    /// <summary>
    /// Erweiterungsmethoden für XML Serialisierung/ Deserialisierung
    /// </summary>
    public static class XmlSerializationExtensions
    {/*
        /// <summary>
        /// serialisiert <paramref name="o" /> als XML mit UTF8 und gibt diesen
        /// String zurück
        /// </summary>
        /// <param name="o"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Deserialisiert den übergebenen String in ein Objekt vom Typ <typeparamref name="T" />
        /// </summary>
*/
        /// <typeparam name="T"></typeparam>
        /// <param name="serializedInstanceOfT"></param>
        /// <returns></returns>
        public static T DeserializeFromXml<T>(
            this string serializedInstanceOfT)
            where T : class
        {
            try{
                var serializer = new XmlSerializer(typeof (T));
                using (var stream = new StringReader(serializedInstanceOfT)){
        ...
        private static T DeserializeFromXmlOrDefault<T>(
            this string serializedInstanceOfT)
            where T : class, new()
        {
            return serializedInstanceOfT.DeserializeFromXmlOrDefault<T>(null);
        }
        private static T DeserializeFromXmlOrDefault<T>(
            this string serializedInstanceOfT,
            Action<T> setDefault)
        ...
        {
            T newT;
            if (string.IsNullOrEmpty(serializedInstanceOfT)
                || (newT = serializedInstanceOfT.DeserializeFromXml<T>()) == null){
                newT = new T();
...
/*
        /// <summary>
        /// Serialisiert <paramref name="o" /> als XML mit UTF8 und speichert
        /// den String in der Datei <paramref name="filePath" />
        /// </summary>
        /// <param name="o"></param>
        /// <param name="filePath"></param>
        public static void SerializeToXmlFile(this object o, string filePath)
        {
            var content = o.SerializeToXml() ?? string.Empty;
            File.WriteAllText(filePath, content);
        }

        /// <summary>
        /// Deserialisiert den Inhalt der mittels Dateipfad übergebenen Textdatei
        /// in ein Objekt vom Typ <typeparamref name="T" />
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="filePath"></param>
        /// <returns></returns>
        public static T DeserializeFromXmlFileOrDefault<T>(
            ...
            where T : class, new()
        {
            ...
            return fileContent.DeserializeFromXmlOrDefault<T>();
        }
*/
    }
}